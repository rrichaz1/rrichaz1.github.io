...
Bayes inverse probability represents the simplest Bayesian network. Disease ->Test 
1.	A -> B -> C,  B is the mediator
2.	A <-B ->C, This is  fork where B is the confounder
3.	A -> B <- C , is a collider
...
Tribes	Symbolists	Connectionists	Evolutionaries	Bayesians	
...
1.	Master Algorithm (fau.edu) 
2.	Pedro Domingos on Machine Learning and the Master Algorithm - Econlib (econtalk.org)
3.	Neural Networks - Neuron (stanford.edu)
4.	Genetic Algorithm and its usage in neural network | TheAILearner
5.	Bayesian Network - The Decision Lab
6.	[Alchemy - Open Source AI (washington.edu)](Pedro Domingos's The Master Algorithm: How the Quest for the Ultimate Learning Machine Will Remake Our World
...
7.	What is Curse of Dimensionality? A Complete Guide | Built In
8.	AlphaGo | DeepMind
9.	The Book of Why: The New Science of Cause and Effect: Pearl, Judea, Mackenzie, Dana: 9780465097609: Amazon.com: Books
![Uploading image.png…]()
